<template>
  <div>
    ...
    <div class="container mx-auto w-screen">
      <div class="grid grid-cols-12 gap-2 justify-items-center">
        <div class="col-span-12 md:col-span-2"></div>
        <div class="col-span-12 md:col-span-8">
          <p class="text-2xl font-semibold antialiased text-center">
              Whoops! Well, it looks like this scholarship has <strong class="text-extrabold">ended!</strong>
          </p>
        </div>
        <div class="col-span-12 md:col-span-2"></div>
      </div>

      <div class="grid grid-cols-12 gap-2 justify-items-center mt-1">
        <div class="col-span-12 md:col-span-2"></div>
        <div class="col-span-12 md:col-span-8">
